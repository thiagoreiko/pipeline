...
class PipelineUtilities {
  ...
  static def executeApprovalFlow(script, time, submitter, approvalNotificationRecipient) {
    ...
    script.input message: 'Scripts de banco de dados autorizado?', ok: 'Teste', parameters: [choice(choices: ['Sim', 'Nao'], description: 'Aprovado', name: 'APROVADO')], submitter: 'ct15184', submitterParameter: 'approved'
